...
{
	if(portn==0)	PWM_buf[0]=	PwmN;
	else if (portn==1)PWM_buf[1]=PwmN ;
	else if (portn==2)	PWM_buf[2]=PwmN;
	 ...
	 if(DISPLAY_ALO==DisplayCont)
	 	{
			...
			else LCD_buf[SEG_PPM_ADDR ]|= SEG_PPM;
		}
