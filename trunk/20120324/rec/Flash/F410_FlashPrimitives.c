...
BYTE code     DUMY1[FLASH_SIZE-FLASH_LAST] _at_	FLASH_LAST;  //空间用作系统

BYTE code     EEPROM_TMP[FLASH_PAGESIZE] _at_	FLASH_TEMP ; //空间用作交换
BYTE code     EEPROM_ENU[EEPROM_SIZE] _at_	EEPROM_ADDR_START ; //空间用作eeprom
